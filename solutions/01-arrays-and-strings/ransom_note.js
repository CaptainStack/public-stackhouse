...
function ransom_note(note, string_repo) {
  // Given a string, a "ransom note," and a second string, a "collection of newspapers/magazines," write 
  // a function that returns true if the second string contains the correct collection of characters such 
  // that the ransom note can be recreated and return false otherwise.
  ...
  // Iterate through the string repo and remove characters from the character map one at a time if they
  // were in the original ransom note. If the map is successfully emptied, the note can be recreated and
